...
PAYMENT_CHANNEL_ADDR="${PAYMENT_CHANNEL_ADDRESS:-${PAYMENT_CHANNEL_ADDR:-0xA2665f2Fdf23CAA362b63F7A8902466f0504332d}}"
ADJUDICATOR_ADDR="${ADJUDICATOR_ADDRESS:-${ADJUDICATOR_ADDR:-0x8C913a936F99e93e298f7800f14C46C32D71e26B}}"
