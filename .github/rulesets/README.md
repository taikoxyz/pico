...
Requires admin access on `dantaik/tainnel`.

```bash
gh api \
  --method POST \
  -H "Accept: application/vnd.github+json" \
  /repos/dantaik/tainnel/rulesets \
...
```bash
gh api /repos/dantaik/tainnel/rulesets
gh api /repos/dantaik/tainnel/rulesets/<ID>
```
...
gh api \
  --method PUT \
  -H "Accept: application/vnd.github+json" \
  /repos/dantaik/tainnel/rulesets/<ID> \
  --input .github/rulesets/main.json
```
